...
/**
 * A <code>AustraliaPostConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link AustraliaPostConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.7.2", date = "2015-12-17T06:30:33+08:00", comments = "Build 3.7.x.2633.51164b9")
public abstract class AustraliaPostConnectorLifecycleInjectionAdapter
    extends AustraliaPostConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(AustraliaPostConnectorLifecycleInjectionAdapter.class);
