...
import org.mule.modules.australiapost.adapters.AustraliaPostConnectorRestClientAdapter;
import org.mule.modules.australiapost.config.ConnectorConfig;
import org.mule.modules.australiapost.pooling.DevkitGenericKeyedObjectPool;


/**
 * A {@code AustraliaPostConnectorConfigConnectionManagementConnectionManager} is a wrapper around {@link AustraliaPostConnector } that adds connection management capabilities to the pojo.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.7.2", date = "2015-12-17T06:30:33+08:00", comments = "Build 3.7.x.2633.51164b9")
public class AustraliaPostConnectorConfigConnectionManagementConnectionManager
    extends ExpressionEvaluatorSupport
    implements MetadataAware, MuleContextAware, ProcessAdapter<AustraliaPostConnectorRestClientAdapter> , Capabilities, Disposable, Initialisable, Testable, ConnectionManagementConnectionManager<ConnectionManagementConfigAustraliaPostConnectorConnectionKey, AustraliaPostConnectorRestClientAdapter, ConnectorConfig>
{
    ...
    public AustraliaPostConnectorRestClientAdapter acquireConnection(ConnectionManagementConfigAustraliaPostConnectorConnectionKey key)
        throws Exception
    {
        return ((AustraliaPostConnectorRestClientAdapter) connectionPool.borrowObject(key));
    }

    public void releaseConnection(ConnectionManagementConfigAustraliaPostConnectorConnectionKey key, AustraliaPostConnectorRestClientAdapter connection)
        throws Exception
    {
        connectionPool.returnObject(key, connection);
    }

    public void destroyConnection(ConnectionManagementConfigAustraliaPostConnectorConnectionKey key, AustraliaPostConnectorRestClientAdapter connection)
        throws Exception
    {
    ...
    @Override
    public<P >ProcessTemplate<P, AustraliaPostConnectorRestClientAdapter> getProcessTemplate() {
        return new ConnectionManagementProcessTemplate(this, muleContext);
    }

    @Override
    public ConnectionManagementConfigAustraliaPostConnectorConnectionKey getDefaultConnectionKey() {
        return new ConnectionManagementConfigAustraliaPostConnectorConnectionKey(getUsername(), getPassword());
    }

    @Override
    public ConnectionManagementConfigAustraliaPostConnectorConnectionKey getEvaluatedConnectionKey(MuleEvent event)
        throws Exception
    {
        if (event!= null) {
            ...
            return new ConnectionManagementConfigAustraliaPostConnectorConnectionKey(_transformedUsername, _transformedPassword);
        }
    ...
    @Override
    public ConnectionManagementConfigAustraliaPostConnectorConnectionKey getConnectionKey(MessageProcessor messageProcessor, MuleEvent event)
        throws Exception
    {
    ...
    public ConnectionManagementConnectionAdapter newConnection() {
        ConnectorConfigAustraliaPostConnectorAdapter connection = new ConnectorConfigAustraliaPostConnectorAdapter();
        connection.setGreeting(getGreeting());
        connection.setReply(getReply());
        return connection;
    }

    @Override
    public ConnectionManagementConnectorAdapter newConnector(ConnectionManagementConnectionAdapter<ConnectorConfig, ConnectionManagementConfigAustraliaPostConnectorConnectionKey> connection) {
        AustraliaPostConnectorRestClientAdapter connector = new AustraliaPostConnectorRestClientAdapter();
    ...
    public ConnectionManagementConnectionAdapter getConnectionAdapter(ConnectionManagementConnectorAdapter adapter) {
        AustraliaPostConnectorRestClientAdapter connector = ((AustraliaPostConnectorRestClientAdapter) adapter);
    ...
    public TestResult test() {
        try {
            ConnectorConfigAustraliaPostConnectorAdapter strategy = ((ConnectorConfigAustraliaPostConnectorAdapter) newConnection());
